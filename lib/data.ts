...
export const projects: readonly Project[] = [
  ...
  },
  {
    ...
    tag: "2024 / software",
    blurb: [
      { type: "text", value: "Development pipeline for " },
      { type: "term", value: "automated CAD" },
      { type: "text", value: " using " },
      { type: "term", value: "AI" },
      { type: "text", value: ". It combines " },
      { type: "term", value: "text-to-CAD" },
      { type: "text", value: " with learned geometry generation to move from a natural-language brief to " },
      { type: "term", value: "3D-printable" },
      { type: "text", value: " output with less manual modeling. Still early, but the workflow targets repeatable, description-driven design." },
    ],
    technologies: ["CAD", "Text-to-CAD", "AI", "3D Printing", "Fusion 360"],
  },
  {
